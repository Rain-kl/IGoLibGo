...
func (p *Plugin) Apply(ctx *core.Context) error {
	ctx.Bind(shared.SetDBService)
	ctx.Bind(shared.SetCacheService)
	ctx.Bind(shared.SetStorageService)
	ctx.Bind(shared.SetTaskService)
	ctx.Bind(shared.SetAuthService)
