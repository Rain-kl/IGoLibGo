    ...
    <div className='space-y-6'>
      ...
      <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
        <Card className='border border-dashed shadow-none'>
          ...
          <CardContent>
            <div className='text-2xl font-semibold font-mono tracking-tight text-sky-500'>
        ...
        <Card className='border border-dashed shadow-none'>
          ...
          <CardContent>
            <div className='text-2xl font-semibold font-mono tracking-tight text-emerald-500'>
        ...
        <Card className='border border-dashed shadow-none'>
          ...
          <CardContent>
            <div className='text-2xl font-semibold font-mono tracking-tight text-indigo-500'>
        ...
        <Card className='border border-dashed shadow-none'>
          ...
          <CardContent>
            <div className='text-2xl font-semibold font-mono tracking-tight text-amber-500'>
      ...
      <div className='grid gap-6 md:grid-cols-2'>
        {/* 饼图 1: 格式数量分布 */}
        <Card className='border border-dashed shadow-none flex flex-col'>
          <CardHeader>
            <CardTitle className='text-sm font-semibold'>
          ...
          <CardContent className='flex-1 flex flex-col justify-between gap-4'>
            ...
            <div className='bg-primary/5 border border-primary/10 rounded-lg p-3 flex items-start gap-2.5 text-xs text-primary'>
